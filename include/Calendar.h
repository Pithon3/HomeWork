//Calendar.h - Header for Calendar - Aidan St G
...
class Calendar
{
    public:
        ...
        void addAssignment( Assignment* a, int day );
        void removeAssignment( Assignment* a, int day );
        Array<Assignment>* getAssignmentsList( int day );
        ...
        const string months[ 13 ] = { "--NONE--", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December" };
    ...
    private:
        ...
        Array< Array<Assignment> >* calendar;
};
